...
const validateSchema = Yup.object({
  email: Yup.string().email().required("Это поле обязательное для заполнения"),
  password: Yup.string().required("Это поле обязательное для заполнения"),
  group: Yup.string().required("Это поле обязательное для заполнения"),
});
