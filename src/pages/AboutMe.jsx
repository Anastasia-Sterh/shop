...
export function AboutMe() {
  ...
  const {
    ...
    isError: isErrorMyProducts,
    error: errorMyProducts,
    ...
    <>
      <div className="userWindow">
        <div className="userWindow__content">
          ...
          >
            <div
              className="userWindow__content-avatar-overlay"
              onClick={() => {
                setEditAvatarModalShown(true);
              }}
            >
      ...
      <Modal
        ...
        closeModal={() => setEditModalShown(false)}
      >
        <EditUserModal
          user={user}
      ...
      <Modal
        isOpen={editAvatarModalShown}
        closeModal={() => setEditAvatarModalShown(false)}
      >
        <EditUserAvatarModal
          user={user}
          setEditAvatarModalShown={setEditAvatarModalShown}
          refetch={refetch}
        />
      </Modal>
    </>
