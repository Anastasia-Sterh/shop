  ...
  const priceOfProductsInCartWithDiscount = () => {
    ...
    for (const product of products) {
      ...
      if (haveCheckbox.includes(cartItem.id)) {
        price =
          price +
          optionalPrice(product.price, product.discount) * cartItem.count;
      }
    }
    return price;
  };
      ...
      <div className="cart">
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    ...
                    onChange={() => dispatch(toggleSelectAll(ids))}
                  />
                }
                label="Выбрать все"
              />
        ...
        <div className="cart__right">
          <Paper className="cart__right-info" elevation={2}>
            ...
            <p>Ваша выгода:</p>{" "}
            {priceOfProductsInCart() - priceOfProductsInCartWithDiscount()} ₽
